...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://leomdzporns-tmhr.vercel.app',
  }
};
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-gray-100 font-sans">
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-12">
        <div className="mb-8 flex items-end justify-between border-b border-white/10 pb-4">
          <div>
            <h2 className="text-2xl font-bold text-white">Vídeo em destaque de hoje</h2>
            <p className="text-sm text-gray-400 mt-1">A lista de vídeos é selecionada automaticamente.</p>
          </div>
        </div>
